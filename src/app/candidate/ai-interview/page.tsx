...
export default function AIInterviewSetup() {
  ...
  return (
    <div className="w-full bg-white overflow-hidden flex min-h-screen" style={{ fontFamily: 'Inter, sans-serif' }}>
      <style>{`
        :root {
          ...
          <form className="space-y-6 flex-1 overflow-y-auto custom-scrollbar pr-2 pb-20">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-100 p-1.5 rounded-2xl flex">
                <button 
                  className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${difficulty === 'easy' ? 'bg-white shadow-sm border border-gray-200 text-gray-900 font-bold' : 'text-gray-500 hover:bg-gray-200'}`}
                  type="button"
                  onClick={() => setDifficulty('easy')}
                >Easy</button>
                <button 
                  className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${difficulty === 'medium' ? 'bg-white shadow-sm border border-gray-200 text-gray-900 font-bold' : 'text-gray-500 hover:bg-gray-200'}`}
                  type="button"
                  onClick={() => setDifficulty('medium')}
                >Medium</button>
                <button 
                  className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${difficulty === 'hard' ? 'bg-white shadow-sm border border-gray-200 text-gray-900 font-bold' : 'text-gray-500 hover:bg-gray-200'}`}
                  type="button"
    ...
    </div> className="w-[280px] bg-[var(--deep-charcoal)] flex flex-col items-center py-10 text-white shrink-0">
