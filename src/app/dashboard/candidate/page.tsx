          ...
          <div className="p-6">
            ...
            <div className="bg-white rounded-[28px] p-4 shadow-sm border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                />
                <input
                  className="flex-1 bg-gray-50 border-none rounded-2xl h-11 text-sm focus:ring-1 focus:ring-blue-500"
              ...
              <div className="flex justify-between mt-4 px-2">
                <button className="flex items-center text-xs font-semibold text-gray-500 hover:text-blue-500">
                  <span className="material-symbols-outlined text-lg mr-1 text-blue-400">
                    image
                  </span>{" "}
                  Media
                </button>
                <button className="flex items-center text-xs font-semibold text-gray-500 hover:text-green-500">
                  <span className="material-symbols-outlined text-lg mr-1 text-green-400">
                    event
                  </span>{" "}
                  Event
                </button>
                <button className="flex items-center text-xs font-semibold text-gray-500 hover:text-yellow-500">
                  <span className="material-symbols-outlined text-lg mr-1 text-yellow-400">
                    article
                  </span>{" "}
                  Write article
                </button>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    {post.avatar ? (
                      ...
                      <div className="w-11 h-11 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 font-bold text-sm">
                        {post.initials}
                      </div>
                    )}
                    <div>
                ...
                <div className="flex items-center justify-between mt-5 pt-4 border-t border-gray-50">
                  <div className="flex space-x-4">
                    ...
                    <button
                      className={`flex items-center space-x-1 ${
                        selectedPost === idx ? "text-blue-600" : "text-gray-500"
                      }`}
                    >
                      <span className="material-symbols-outlined text-lg">
                        chat_bubble
          ...
          <div className="flex-1 overflow-y-auto px-12 pt-16 pb-32 custom-scrollbar">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex items-center space-x-4 mb-6">
                <img
                  alt={posts[selectedPost].author}
                  className="w-16 h-16 rounded-full object-cover border-4 border-white shadow-lg"
                  src={
                    posts[selectedPost].avatar ||
                ...
                <div>
                  ...
                  <p className="text-gray-500 font-medium">
                    {posts[selectedPost].role} at Creative Studio
                  </p>
                </div>
              </div>
              ...
              <div className="mb-10">
                <p className="text-lg text-gray-700 leading-relaxed">
                  {posts[selectedPost].content} I'd love to hear your thoughts
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  ...
                  <span className="px-4 py-1.5 bg-yellow-100 text-yellow-700 text-xs font-bold rounded-full">
                    #DesignSystem
                  </span>
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                  ...
                  <button className="text-sm font-semibold text-gray-500 flex items-center">
                    Most Relevant{" "}
                  ...
                  <div className="flex-1">
                    <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-50">
                      <div className="flex justify-between items-start mb-1">
                        <h5 className="font-bold text-sm">George K.</h5>
                        <span className="text-[10px] text-gray-400">
                          12m ago
                        </span>
                      </div>
                      <p className="text-sm text-gray-600">
                        The high-contrast approach is exactly what we need for
                        the dashboard. Those pastel tags really pop against the
                        dark sidebar!
                      </p>
                    </div>
                    <div className="flex items-center space-x-4 mt-2 ml-4">
                      <button className="text-xs font-bold text-gray-400 hover:text-blue-500">
                        Like
                      </button>
                      <button className="text-xs font-bold text-gray-400 hover:text-blue-500">
                        Reply
                    ...
                    {/* Nested Reply */}
                    <div className="flex space-x-4 mt-4 ml-4 border-l-2 border-gray-100 pl-4">
                      <div className="w-8 h-8 rounded-full bg-gray-900 shrink-0 flex items-center justify-center text-white text-[10px] font-bold">
                        SJ
                      </div>
                      <div className="flex-1">
                        <div className="bg-gray-50 p-4 rounded-3xl">
                          <div className="flex justify-between items-start mb-1">
                            <h5 className="font-bold text-sm">
                              Sarah Jenkins{" "}
                              <span className="text-[10px] font-normal text-blue-500 bg-blue-50 px-1.5 py-0.5 rounded ml-1">
                                Author
                              </span>
                            </h5>
                            <span className="text-[10px] text-gray-400">
                          ...
                          <p className="text-sm text-gray-600">
                            Thanks George! Trying to balance aesthetics with
                            usability is always the goal.
                          </p>
                        </div>
                ...
                <div className="flex space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-50">
                      <div className="flex justify-between items-start mb-1">
                        <h5 className="font-bold text-sm">Alex Rivers</h5>
                        <span className="text-[10px] text-gray-400">
                          1h ago
                        </span>
                      </div>
                      <p className="text-sm text-gray-600">
                        Which font are you using for the headings? Looks very
                        clean.
                      </p>
                    </div>
                    <div className="flex items-center space-x-4 mt-2 ml-4">
